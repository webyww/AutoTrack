...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_data_path", type=str, default="dataset/kitti/datasets/")
    parser.add_argument("--dets_path", type=str, default="dataset/kitti/detectors/")

    parser.add_argument("--save_path", type=str, default="./dataset/base_version/kitti/")
